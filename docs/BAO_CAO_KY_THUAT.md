...
bảng vẽ cảm ứng). Đề tài này chứng minh rằng chỉ với **một webcam thông thường
...
protocol; server relay nằm ngoài phạm vi đề tài.
...
Đề tài hoàn thành mục tiêu đặt ra: một ứng dụng web thuần client cho phép vẽ
